    ...
    const approvalStage = pipeline.addStage({
        ...
        actions:[
            new codepipelineactions.ManualApprovalAction({
                ...
                externalEntityLink: 'https://console.aws.amazon.com/codesuite/codecommit/repositories/DemoApp/commit/' + sourceAction.variables.commitId + '?region=ap-northeast-1' //+ buildAction.variable('AWS_DEFAULT_REGION') 
            })
        ]
    })
